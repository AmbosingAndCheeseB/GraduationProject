...
def build_CNN_classifier(x):
    ...
    W_conv1 = tf.Variable(tf.truncated_normal(shape= [5, 5, 3, 64], stddev = 5e-2)) # stddev 표준편차
...
with tf.Session() as sess:
    ...
    for i in range(10000):
        ...
        if i % 100 == 0:
            ...
            print("Epoch : %d, 정확도 : %f loss : %f" % (i, train_accuracy, loss_print))
    ...
    print("test data 정확도 : %f" % (test_accuracy))